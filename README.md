...
import (
	...
	nuke_aws "github.com/terraform-modules-krish/cloud-nuke/aws"
...
This code is released under the MIT License. See [LICENSE.txt](https://github.com/terraform-modules-krish/cloud-nuke/blob/v0.32.1-test-signing-binaries/LICENSE.txt).
